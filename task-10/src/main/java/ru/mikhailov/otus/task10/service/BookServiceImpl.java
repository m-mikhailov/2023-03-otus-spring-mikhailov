...
import ru.mikhailov.otus.task10.repository.AuthorRepository;
import ru.mikhailov.otus.task10.repository.BookRepository;
import ru.mikhailov.otus.task10.repository.GenreRepository;

import java.util.List;
import java.util.Objects;

import static ru.mikhailov.otus.task10.domain.error.EntityNotFoundException.*;
