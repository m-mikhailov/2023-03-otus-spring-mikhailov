...
import ru.mikhailov.otus.task9.repository.BookRepository;
import ru.mikhailov.otus.task9.repository.GenreRepository;

import java.util.List;
import java.util.Objects;

import static ru.mikhailov.otus.task9.domain.error.EntityNotFoundException.*;
